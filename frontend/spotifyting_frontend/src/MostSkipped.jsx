...
const TopArtists = ({ most_skipped }) => {


  return (
    <section className="bg-base-100 rounded-xl border-base-300 border py-12">
        <div className="container px-4">
            <h2 className="text-3xl font-bold mb-6 text-center">Most Skipped Tracks</h2> 
            {most_skipped ? (
                <ul className="list flex flex-col gap-2">
                    {Object.entries(most_skipped).sort((a, b) => b[1] - a[1] ).map(([song, count], index) => (
